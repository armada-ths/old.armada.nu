...
const KnightecSpeakers = () =>{
    ...
    const speakers = [
        ...
        {name:'Sara Mazur', workTitle:'Chairwomen and Director of the Board', education:'MSc Electrical Engineering, KTH', linkedInUrl:'https://www.linkedin.com/in/sara-mazur-479535187/', profileImageUrl:'', zoomUrl:'', description:'Since 2007, Sara is a member of the Royal Swedish Academy of Engineering Sciences. She also has several board assignments, for example, Chairwomen in Wallenberg Artificial Intelligence, Director of the board at Saab, and Combitech.'}
    ]

    const speakers2 = [
        {name: 'Kit Gullbrandsson', profileImageUrl: '', description: ''},
        {name: 'Sigbritt Karlsson', profileImageUrl: '', description: ''}
    ]
    ...
    const createCards = (start, end) => {
      ...
      return (<div><div className='speakers'>
    ...
    Our guests will share their stories and best tips for the future. There will also be time for you to ask questions, so take the opportunity to learn from and connect with some of the best KTH alumni! 

    To finish up, Sigbritt Karlsson, principal of KTH will share some words of inspiration for the future.</p>
