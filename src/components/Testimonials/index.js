...
const Testimonials = () => {
    ...
    useEffect(() => {
      ...
      const people = [
        {name: 'Daniel Aston', role: 'Project Manager 2020', statement: 'I\'ve met so many fun people!', image: '/assets/images/PG20/danieldrake.jpg'},
        {name: 'Lucas Wallhager', role: 'Head of Career Fair 2020', statement: 'Armada is a great opportunity to develop skills for the future in a fun environment, where everyone is working for a common goal.', image: '/assets/images/PG20/lucasliqour.jpg'},
        {name: 'Elias Ljunggren', role: 'Head of Service and Sponsorship 2020', statement: 'Armada is freakin\' amaaazing!!', image: '/assets/images/PG20/eliaseagle.jpg'},
        {name: 'Pavel Askari', role: 'Head of Sales 2020', statement: 'It’s a experience you will never forget!', image: '/assets/images/PG20/pavelpeach.jpg'},
        {name: 'Leonard Hökby', role: 'Head of Logistics and Career Fair 2020', statement: 'You get the chance to do something meaningful and fun at the same time.', image: '/assets/images/PG20/leolionposter.jpg'},
        {name: 'Camilla Blomqvist', role: 'Head of Sustainability 2020', statement: 'I love being a part of Armada and that I have the ability to make it more sustainable than ever!', image: '/assets/images/PG20/camillachocolate.jpg'},
        {name: 'Sandra Ransed', role: 'Head of Media & Marketing 2020', statement: 'The best student engagement I have done so far!', image: '/assets/images/PG20/sandrasavage.jpg'},
        {name: 'Kevin Stojanovski', role: 'Head of Business Relations and Events 2020', statement: 'In times of change, Armada adapts.', image: '/assets/images/PG20/kevinkelvin.jpg'},
