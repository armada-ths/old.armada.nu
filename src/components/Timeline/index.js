...
const images=[
  ...
  pgImage:"/assets/images/projectgroup-armada.jpg", summerImage: "/assets/images/summer.jpg", arunImage: "/assets/images/armada-run.jpg", 
...
const Timeline = ()=>{
  ...
  <div className="containerleft leftleft">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].salesOpenImage}/></div>
      </div>
  </div>
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].otImage}/></div>
      </div>
  </div>
  <div className="containerleft leftleft">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].salesEndImage}/></div>
      </div>
  </div>
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].summerImage}/></div>
      </div>
  </div>
  <div className="containerleft leftleft">
    <div className="contentt">
  ...
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].hostImage}/></div>
      </div>
  </div>
  <div className="containerleft leftleft">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].kickOffImage}/></div>
      </div>
  </div>
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].arunImage}/></div>
      </div>
  </div>
  <div className="containerleft leftleft">
    <div className="contentt">
  ...
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].banquetImage}/></div>
      </div>
  </div>
  <div className="containerleft leftleft">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].kickOutImage}/></div>
      </div>
  </div>
  <div className="containerright rightright">
    <div className="contentt">
      ...
      <div id="images"><img id="timeline_pic" src={images[0].writeImage}/></div>
      </div>
  </div>
</div>
);
