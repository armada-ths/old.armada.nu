          ...
          <div className='modalinfo'>
            ...
            <div className='modal-property-event'>
              <div className='icon-group'>
                <img alt='' className='icon' src='/assets/calendar-round.svg' />
              ...
              <div className='icon-group'>
                <img alt='' className='icon' src='/assets/clock.svg' />
                <p className='time' > {hours + ':' + minutes.substr(-2) + '-' + endhours + ':' + endminutes.substr(-2)}</p>
              </div>
              <div className='icon-group'>
                <img alt='' className='icon' src='/assets/place.svg' />
                <p> {event.location}</p>
              </div>
            </div>
        ...
        <div role='presentation' className='event-item' onClick={() => this.showModal(event.id)}>
          ...
          <div className='details-section'>
            ...
            <div className='event-property'>
              <img alt='date' className='icon' src='/assets/date.png' />
              <p> {this.getOrdinalNum(date.getDate())} {monthNames[date.getMonth()]} </p>
            </div>
            <div className='event-property'>
              <img alt='location' className='icon' src='/assets/location.png' />
              <p> {event.location}</p>
            </div>
            <div className='event-property'>
