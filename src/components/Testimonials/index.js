...
const Testimonials = () => {
    ...
    useEffect(() => {
      ...
      const people = [
        ...
        {name: 'Sandra Ransed', role: 'Head of Media & Marketing', statement: 'The best student engagement I have done so far!', image: '/assets/images/PG20/sandrasavage.jpg'},
        {name: 'Kevin Stojanovski', role: 'Head of Business Relations and Events', statement: 'In times of change, Armada adapts.', image: '/assets/images/PG20/kevinkelvin.jpg'},
