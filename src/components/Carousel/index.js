...
const Carousel = props => {
    ...
    const handlerPrev = () => {
        setCurrent(
            current - shownItems < 0
                ? length - (length % shownItems) - 1
                : current - shownItems
        )
    }
        ...
        <div>
            <div className='carousel'>
                {isTraversable ? (
                    <div
                        role='presentation'
                        className='carousel-control prev no-tap-highlight'
                        onClick={handlerPrev}
                    >
                        <span></span>
                    </div>
                ...
                <div
                    ...
                    style={{
                        gridTemplateColumns: `repeat(${shownItems}, 1fr)`,
                    }}
                >
                ...
                {isTraversable ? (
                    <div
                        role='presentation'
                        className='carousel-control next no-tap-highlight'
                        onClick={handlerNext}
                    >
                        <span></span>
                    </div>
            ...
            {group(items, shownItems).map((el, index) => (
                <div
                    ...
                    className={`history-item ${
                        index * shownItems >= current &&
                        index * shownItems + shownItems <= current + shownItems
                            ? 'active'
                            : ''
                    }`}
