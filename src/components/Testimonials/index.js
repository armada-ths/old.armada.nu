...
const Testimonials = () => {
  ...
  const testimonialObjects = [
    {name: "Ananya", role: "Diversity Coordinator", statement: "\"I feel proud and excited to be part of scandinavia's largest student fair\"", image: ""},
    ...
    {name: "Luise", role: "Team Leader Lounges", statement: "\"We do more than just serve free coffee, join the team to find out what!\"", image: ""},
    {name: "Marc", role: "Team Leader Career Fair", statement: "\"Armada is a great way to develop professionally and meet new people\"", image: ""},
    {name: "Pauline", role: "Photo Team Coordinator", statement: "\"I'm very excited to be a part of Scandinavias largest career fair!\"", image: ""},
    {name: "Ella", role: "Head of Events", statement: "\"Joining Armada is just like Nike's slogan: Just Do It!\"", image: "/assets/ella.jpg"},
    {name: "Abhishek", role: "Team Leader Career Fair", statement: "\"Organizing the biggest career fair with lots of fun...Would never miss this chance\"", image: ""},
